...
int main(int argc, char** argv){
  ...
  1c:	74 38                	je     56 <main+0x56>
        int exit_code;
        wait(&exit_code);
  1e:	83 ec 0c             	sub    $0xc,%esp
  21:	8d 45 f4             	lea    -0xc(%ebp),%eax
  24:	50                   	push   %eax
  25:	e8 b1 02 00 00       	call   2db <wait>
        printf(1, "This is the parent\n");
  2a:	5a                   	pop    %edx
  2b:	59                   	pop    %ecx
  2c:	68 98 07 00 00       	push   $0x798
  31:	6a 01                	push   $0x1
  ...
  43:	6a 01                	push   $0x1
  45:	e8 e6 03 00 00       	call   430 <printf>
        exit(1);
  ...
  5f:	e8 cc 03 00 00       	call   430 <printf>
        exit(11);
  64:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb ce 07 00 00       	mov    $0x7ce,%ebx
        while(*s != 0){
