  ...
  13:	31 db                	xor    %ebx,%ebx
{
  ...
  28:	e8 ae 03 00 00       	call   3db <sbrk>
        * (char *) pointers[i] = (char) ('a' + i);
  2d:	8d 53 61             	lea    0x61(%ebx),%edx
    for (i = 0 ; i < c ; i++){
  30:	83 c4 10             	add    $0x10,%esp
        pointers[i] = (uint)sbrk(4096);
  33:	89 44 9d 94          	mov    %eax,-0x6c(%ebp,%ebx,4)
    for (i = 0 ; i < c ; i++){
  37:	83 c3 01             	add    $0x1,%ebx
        * (char *) pointers[i] = (char) ('a' + i);
  3a:	88 10                	mov    %dl,(%eax)
    for (i = 0 ; i < c ; i++){
  3c:	83 fb 15             	cmp    $0x15,%ebx
  3f:	75 df                	jne    20 <main+0x20>
    }

    pid = fork();
  41:	e8 05 03 00 00       	call   34b <fork>

    if(pid == 0){
  46:	85 c0                	test   %eax,%eax
  48:	74 59                	je     a3 <main+0xa3>
    ...
    if(pid != 0){
        wait();
  4a:	e8 0c 03 00 00       	call   35b <wait>
    }

    if(pid != 0){
    printf(1,"FATHER : \n");
  4f:	8d 5d 94             	lea    -0x6c(%ebp),%ebx
  52:	8d 75 e8             	lea    -0x18(%ebp),%esi
  55:	50                   	push   %eax
  56:	50                   	push   %eax
  57:	68 2d 08 00 00       	push   $0x82d
  5c:	6a 01                	push   $0x1
  ...
  99:	e8 12 04 00 00       	call   4b0 <printf>
    ...
    exit();
  9e:	e8 b0 02 00 00       	call   353 <exit>
    printf(1,"SON : \n");
  a3:	52                   	push   %edx
  a4:	8d 5d 94             	lea    -0x6c(%ebp),%ebx
  a7:	8d 75 e8             	lea    -0x18(%ebp),%esi
  aa:	52                   	push   %edx
  ab:	68 18 08 00 00       	push   $0x818
  b0:	6a 01                	push   $0x1
  ...
  ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        printf(1,"%c", *(char * )pointers[i]);
  c0:	8b 03                	mov    (%ebx),%eax
  c2:	83 ec 04             	sub    $0x4,%esp
  c5:	83 c3 04             	add    $0x4,%ebx
  c8:	0f be 00             	movsbl (%eax),%eax
  cb:	50                   	push   %eax
  cc:	68 20 08 00 00       	push   $0x820
  d1:	6a 01                	push   $0x1
  d3:	e8 d8 03 00 00       	call   4b0 <printf>
    for (i = 0 ; i < c ; i++){
  d8:	83 c4 10             	add    $0x10,%esp
  db:	39 de                	cmp    %ebx,%esi
  dd:	75 e1                	jne    c0 <main+0xc0>
  df:	eb ae                	jmp    8f <main+0x8f>
  e1:	66 90                	xchg   %ax,%ax
  e3:	66 90                	xchg   %ax,%ax
  e5:	66 90                	xchg   %ax,%ax
  e7:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	eb 1a                	jmp    650 <printf+0x1a0>
          s = "(null)";
 636:	bb 38 08 00 00       	mov    $0x838,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 685:	a1 f0 0a 00 00       	mov    0xaf0,%eax
{
 ...
 6a6:	73 10                	jae    6b8 <free+0x38>
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	a3 f0 0a 00 00       	mov    %eax,0xaf0
}
 6d7:	5e                   	pop    %esi
 6d8:	5f                   	pop    %edi
 6d9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 71d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 720:	8b 3d f0 0a 00 00    	mov    0xaf0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 769:	8b 3d f0 0a 00 00    	mov    0xaf0,%edi
 ...
 792:	e8 e9 fe ff ff       	call   680 <free>
  return freep;
 797:	a1 f0 0a 00 00       	mov    0xaf0,%eax
 ...
 7de:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 f0 0a 00 00 f4 	movl   $0xaf4,0xaf0
 7e7:	0a 00 00 
    base.s.size = 0;
 7ea:	bf f4 0a 00 00       	mov    $0xaf4,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 f4 0a 00 00 f4 	movl   $0xaf4,0xaf4
 7f6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7fb:	c7 05 f8 0a 00 00 00 	movl   $0x0,0xaf8
 802:	00 00 00 
    if(p->s.size >= nunits){
