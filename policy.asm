...
int main(int argc, char** argv){
  ...
  29:	89 c3                	mov    %eax,%ebx
    int result = policy(policy_type);
  2b:	e8 73 03 00 00       	call   3a3 <policy>
    if (result < 0){
  30:	83 c4 10             	add    $0x10,%esp
  33:	85 c0                	test   %eax,%eax
  35:	78 35                	js     6c <main+0x6c>
  37:	b8 7a 08 00 00       	mov    $0x87a,%eax
  3c:	83 fb 02             	cmp    $0x2,%ebx
  3f:	77 07                	ja     48 <main+0x48>
  41:	8b 04 9d 68 08 00 00 	mov    0x868(,%ebx,4),%eax
            break;
        case 2:
  ...
  65:	6a 00                	push   $0x0
  67:	e8 87 02 00 00       	call   2f3 <exit>
        printf(1, "Error replacing policy, no such a policy number (%d)", policy_type);
  6c:	51                   	push   %ecx
  6d:	53                   	push   %ebx
  6e:	68 04 08 00 00       	push   $0x804
  73:	6a 01                	push   $0x1
  75:	e8 f6 03 00 00       	call   470 <printf>
        exit(0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	eb 1a                	jmp    610 <printf+0x1a0>
          s = "(null)";
 5f6:	bb 74 08 00 00       	mov    $0x874,%ebx
        while(*s != 0){
