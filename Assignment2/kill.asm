...
main(int argc, char **argv)
{
  ...
  if(argc < 3){
  1d:	83 fa 02             	cmp    $0x2,%edx
  20:	7e 44                	jle    66 <main+0x66>
    printf(2, "usage: kill pid1 pid2 ... signum\n");
    exit();
  }
  for(i=1; i<argc - 1 ; i++)
    kill(atoi(argv[i]), atoi(argv[argc - 1]));
  22:	8d 14 95 fc ff ff ff 	lea    -0x4(,%edx,4),%edx
  29:	8d 58 04             	lea    0x4(%eax),%ebx
  2c:	8d 3c 10             	lea    (%eax,%edx,1),%edi
  2f:	89 7d e4             	mov    %edi,-0x1c(%ebp)
  ...
  47:	58                   	pop    %eax
  48:	ff 73 fc             	pushl  -0x4(%ebx)
  4b:	e8 20 02 00 00       	call   270 <atoi>
  50:	5a                   	pop    %edx
  51:	59                   	pop    %ecx
  52:	56                   	push   %esi
  53:	50                   	push   %eax
  54:	e8 ba 02 00 00       	call   313 <kill>
  for(i=1; i<argc - 1 ; i++)
  59:	83 c4 10             	add    $0x10,%esp
  5c:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
  5f:	75 d7                	jne    38 <main+0x38>
  exit();
  61:	e8 7d 02 00 00       	call   2e3 <exit>
    printf(2, "usage: kill pid1 pid2 ... signum\n");
  66:	53                   	push   %ebx
  67:	53                   	push   %ebx
  68:	68 b8 07 00 00       	push   $0x7b8
  6d:	6a 02                	push   $0x2
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb da 07 00 00       	mov    $0x7da,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 625:	a1 98 0a 00 00       	mov    0xa98,%eax
{
 ...
 646:	73 10                	jae    658 <free+0x38>
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 677:	5e                   	pop    %esi
 678:	5f                   	pop    %edi
 679:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6bd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6c0:	8b 3d 98 0a 00 00    	mov    0xa98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 709:	8b 3d 98 0a 00 00    	mov    0xa98,%edi
 ...
 732:	e8 e9 fe ff ff       	call   620 <free>
  return freep;
 737:	a1 98 0a 00 00       	mov    0xa98,%eax
 ...
 764:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 767:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 ...
 77e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 98 0a 00 00 9c 	movl   $0xa9c,0xa98
 787:	0a 00 00 
    base.s.size = 0;
 78a:	bf 9c 0a 00 00       	mov    $0xa9c,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 9c 0a 00 00 9c 	movl   $0xa9c,0xa9c
 796:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 79b:	c7 05 a0 0a 00 00 00 	movl   $0x0,0xaa0
 7a2:	00 00 00 
    if(p->s.size >= nunits){
