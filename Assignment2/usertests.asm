...
main(int argc, char *argv[])
{
  ...
  uio();
     107:	e8 14 35 00 00       	call   3620 <uio>

  exectest();
     10c:	e8 ff 08 00 00       	call   a10 <exectest>

  exit();
     111:	e8 7d 38 00 00       	call   3993 <exit>
...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test ok\n");
    ...
    exit();
     1b7:	e8 d7 37 00 00       	call   3993 <exit>
    ...
    exit();
     1ce:	e8 c0 37 00 00       	call   3993 <exit>
    ...
    exit();
     1e5:	e8 a9 37 00 00       	call   3993 <exit>
    ...
    exit();
     1fc:	e8 92 37 00 00       	call   3993 <exit>
...
00000210 <exitiputtest>:
{
  ...
  pid = fork();
     22a:	e8 5c 37 00 00       	call   398b <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    exit();
     280:	e8 0e 37 00 00       	call   3993 <exit>
     285:	8d 76 00             	lea    0x0(%esi),%esi
  wait();
     288:	e8 0e 37 00 00       	call   399b <wait>
  printf(stdout, "exitiput test ok\n");
     ...
     2b6:	e8 45 38 00 00       	call   3b00 <printf>
      exit();
     2bb:	e8 d3 36 00 00       	call   3993 <exit>
    ...
    exit();
     2d2:	e8 bc 36 00 00       	call   3993 <exit>
      printf(stdout, "mkdir failed\n");
     2d7:	52                   	push   %edx
     2d8:	52                   	push   %edx
     ...
     2e4:	e8 17 38 00 00       	call   3b00 <printf>
      exit();
     2e9:	e8 a5 36 00 00       	call   3993 <exit>
     ...
     2fb:	e8 00 38 00 00       	call   3b00 <printf>
      exit();
     300:	e8 8e 36 00 00       	call   3993 <exit>
...
00000310 <openiputtest>:
{
  ...
  pid = fork();
     341:	e8 45 36 00 00       	call   398b <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     370:	e8 8b 37 00 00       	call   3b00 <printf>
      exit();
     375:	e8 19 36 00 00       	call   3993 <exit>
  ...
  wait();
     39d:	e8 f9 35 00 00       	call   399b <wait>
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3c0:	e8 ce 35 00 00       	call   3993 <exit>
    printf(stdout, "fork failed\n");
     3c5:	52                   	push   %edx
     3c6:	52                   	push   %edx
    ...
    exit();
     3d7:	e8 b7 35 00 00       	call   3993 <exit>
    ...
    exit();
     3ee:	e8 a0 35 00 00       	call   3993 <exit>
    ...
    exit();
     405:	e8 89 35 00 00       	call   3993 <exit>
...
00000410 <opentest>:
{
  ...
  printf(stdout, "open test ok\n");
    ...
    exit();
     487:	e8 07 35 00 00       	call   3993 <exit>
    ...
    exit();
     49e:	e8 f0 34 00 00       	call   3993 <exit>
...
000004b0 <writetest>:
{
  ...
  i = read(fd, buf, 2000);
     ...
     59e:	53                   	push   %ebx
     59f:	e8 07 34 00 00       	call   39ab <read>
  if(i == 2000){
  ...
  printf(stdout, "small file test ok\n");
     ...
     60c:	e8 ef 34 00 00       	call   3b00 <printf>
      exit();
     611:	e8 7d 33 00 00       	call   3993 <exit>
     ...
     625:	e8 d6 34 00 00       	call   3b00 <printf>
      exit();
     62a:	e8 64 33 00 00       	call   3993 <exit>
    ...
    exit();
     641:	e8 4d 33 00 00       	call   3993 <exit>
    ...
    exit();
     658:	e8 36 33 00 00       	call   3993 <exit>
    ...
    exit();
     66f:	e8 1f 33 00 00       	call   3993 <exit>
    ...
    exit();
     686:	e8 08 33 00 00       	call   3993 <exit>
...
00000690 <writetest1>:
{
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     754:	53                   	push   %ebx
     755:	e8 51 32 00 00       	call   39ab <read>
    if(i == 0){
  ...
  printf(stdout, "big files ok\n");
     ...
     7b9:	e8 42 33 00 00       	call   3b00 <printf>
      exit();
     7be:	e8 d0 31 00 00       	call   3993 <exit>
     ...
     7d0:	e8 2b 33 00 00       	call   3b00 <printf>
      exit();
     7d5:	e8 b9 31 00 00       	call   3993 <exit>
     ...
     7e9:	e8 12 33 00 00       	call   3b00 <printf>
      exit();
     7ee:	e8 a0 31 00 00       	call   3993 <exit>
     ...
     804:	e8 f7 32 00 00       	call   3b00 <printf>
        exit();
     809:	e8 85 31 00 00       	call   3993 <exit>
    ...
    exit();
     820:	e8 6e 31 00 00       	call   3993 <exit>
    ...
    exit();
     837:	e8 57 31 00 00       	call   3993 <exit>
    ...
    exit();
     84e:	e8 40 31 00 00       	call   3993 <exit>
...
00000920 <dirtest>:
{
  ...
  printf(stdout, "mkdir test ok\n");
    ...
    exit();
     9b7:	e8 d7 2f 00 00       	call   3993 <exit>
    ...
    exit();
     9ce:	e8 c0 2f 00 00       	call   3993 <exit>
    printf(stdout, "chdir .. failed\n");
     9d3:	52                   	push   %edx
     9d4:	52                   	push   %edx
    ...
    exit();
     9e5:	e8 a9 2f 00 00       	call   3993 <exit>
    ...
    exit();
     9fc:	e8 92 2f 00 00       	call   3993 <exit>
...
00000a10 <exectest>:
{
  ...
  if(exec("echo", echoargv) < 0){
    ...
    exit();
     a56:	e8 38 2f 00 00       	call   3993 <exit>
     ...
     a69:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     abc:	e8 ea 2e 00 00       	call   39ab <read>
  ...
  seq = 0;
    ...
    exit();
     b70:	e8 1e 2e 00 00       	call   3993 <exit>
    if(total != 5 * 1033){
    ...
    wait();
     b89:	e8 0d 2e 00 00       	call   399b <wait>
  printf(1, "pipe1 ok\n");
     b8e:	5a                   	pop    %edx
     b8f:	59                   	pop    %ecx
     ...
     baf:	e8 4c 2f 00 00       	call   3b00 <printf>
      exit();
     bb4:	e8 da 2d 00 00       	call   3993 <exit>
    ...
    exit();
     bc7:	e8 c7 2d 00 00       	call   3993 <exit>
    ...
    exit();
     bda:	e8 b4 2d 00 00       	call   3993 <exit>
     ...
     be8:	e8 13 2f 00 00       	call   3b00 <printf>
        exit();
     bed:	e8 a1 2d 00 00       	call   3993 <exit>
...
00000c00 <preempt>:
{
  ...
  pid1 = fork();
     c19:	e8 6d 2d 00 00       	call   398b <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     c32:	e8 54 2d 00 00       	call   398b <fork>
  ...
  pipe(pfds);
     ...
     c46:	50                   	push   %eax
     c47:	e8 57 2d 00 00       	call   39a3 <pipe>
  pid3 = fork();
     c4c:	e8 3a 2d 00 00       	call   398b <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c7d:	0f 85 ae 00 00 00    	jne    d31 <preempt+0x131>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     cb3:	e8 f3 2c 00 00       	call   39ab <read>
     cb8:	83 c4 10             	add    $0x10,%esp
     cbb:	83 f8 01             	cmp    $0x1,%eax
     cbe:	0f 85 84 00 00 00    	jne    d48 <preempt+0x148>
  close(pfds[0]);
     cc4:	83 ec 0c             	sub    $0xc,%esp
     cc7:	ff 75 e0             	pushl  -0x20(%ebp)
     cca:	e8 ec 2c 00 00       	call   39bb <close>
  printf(1, "kill... ");
     ccf:	58                   	pop    %eax
     cd0:	5a                   	pop    %edx
     cd1:	68 2d 42 00 00       	push   $0x422d
     cd6:	6a 01                	push   $0x1
     cd8:	e8 23 2e 00 00       	call   3b00 <printf>
  kill(pid1, SIGKILL);
     cdd:	59                   	pop    %ecx
     cde:	58                   	pop    %eax
     cdf:	6a 09                	push   $0x9
     ce1:	57                   	push   %edi
     ce2:	e8 dc 2c 00 00       	call   39c3 <kill>
  kill(pid2, SIGKILL);
     ce7:	58                   	pop    %eax
     ce8:	5a                   	pop    %edx
     ce9:	6a 09                	push   $0x9
  ...
  kill(pid3, SIGKILL);
     ...
     cf3:	6a 09                	push   $0x9
     cf5:	53                   	push   %ebx
     cf6:	e8 c8 2c 00 00       	call   39c3 <kill>
  printf(1, "wait... ");
     cfb:	5f                   	pop    %edi
     cfc:	58                   	pop    %eax
     cfd:	68 36 42 00 00       	push   $0x4236
     d02:	6a 01                	push   $0x1
     d04:	e8 f7 2d 00 00       	call   3b00 <printf>
  wait();
     d09:	e8 8d 2c 00 00       	call   399b <wait>
  wait();
     d0e:	e8 88 2c 00 00       	call   399b <wait>
  wait();
     d13:	e8 83 2c 00 00       	call   399b <wait>
  printf(1, "preempt ok\n");
     d18:	58                   	pop    %eax
     d19:	5a                   	pop    %edx
     d1a:	68 3f 42 00 00       	push   $0x423f
     d1f:	6a 01                	push   $0x1
     ...
     d31:	83 ec 08             	sub    $0x8,%esp
     d34:	68 06 42 00 00       	push   $0x4206
     d39:	6a 01                	push   $0x1
     d3b:	e8 c0 2d 00 00       	call   3b00 <printf>
     d40:	83 c4 10             	add    $0x10,%esp
     d43:	e9 3b ff ff ff       	jmp    c83 <preempt+0x83>
    printf(1, "preempt read error");
     d48:	83 ec 08             	sub    $0x8,%esp
     d4b:	68 1a 42 00 00       	push   $0x421a
     d50:	6a 01                	push   $0x1
     d52:	e8 a9 2d 00 00       	call   3b00 <printf>
    return;
     d57:	83 c4 10             	add    $0x10,%esp
     d5a:	eb cd                	jmp    d29 <preempt+0x129>
...
00000d60 <exitwait>:
{
    ...
    if(pid){
     d70:	74 68                	je     dda <exitwait+0x7a>
      if(wait() != pid){
     d72:	e8 24 2c 00 00       	call   399b <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d80:	e8 06 2c 00 00       	call   398b <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     dd9:	c3                   	ret    
      exit();
     dda:	e8 b4 2b 00 00       	call   3993 <exit>
     ddf:	90                   	nop
...
00000de0 <mem>:
{
  ...
  if((pid = fork()) == 0){
     e01:	e8 85 2b 00 00       	call   398b <fork>
    ...
    exit();
     e77:	e8 17 2b 00 00       	call   3993 <exit>
     ...
     e91:	6a 09                	push   $0x9
     e93:	53                   	push   %ebx
     e94:	e8 2a 2b 00 00       	call   39c3 <kill>
      exit();
     e99:	e8 f5 2a 00 00       	call   3993 <exit>
     ...
     ea5:	5d                   	pop    %ebp
    wait();
     ea6:	e9 f0 2a 00 00       	jmp    399b <wait>
...
00000eb0 <sharedfd>:
{
  ...
  pid = fork();
     efb:	e8 8b 2a 00 00       	call   398b <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     f13:	50                   	push   %eax
     f14:	56                   	push   %esi
     f15:	e8 d6 28 00 00       	call   37f0 <memset>
  ...
  if(pid == 0)
    ...
    wait();
     f56:	e8 40 2a 00 00       	call   399b <wait>
  close(fd);
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f9c:	e8 0a 2a 00 00       	call   39ab <read>
  ...
  if(nc == 10000 && np == 10000){
    ...
    104a:	c3                   	ret    
    exit();
    104b:	e8 43 29 00 00       	call   3993 <exit>
    ...
    exit();
    105e:	e8 30 29 00 00       	call   3993 <exit>
    ...
    107f:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    pid = fork();
    10b8:	e8 ce 28 00 00       	call   398b <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    10dc:	e8 ba 28 00 00       	call   399b <wait>
  for(i = 0; i < 2; i++){
    10e1:	31 f6                	xor    %esi,%esi
    wait();
    10e3:	e8 b3 28 00 00       	call   399b <wait>
    10e8:	e8 ae 28 00 00       	call   399b <wait>
    10ed:	e8 a9 28 00 00       	call   399b <wait>
    fname = names[i];
    ...
    1120:	e8 86 28 00 00       	call   39ab <read>
  ...
  printf(1, "fourfiles ok\n");
    ...
    11a9:	e8 52 29 00 00       	call   3b00 <printf>
          exit();
    11ae:	e8 e0 27 00 00       	call   3993 <exit>
    ...
    11e0:	e8 0b 26 00 00       	call   37f0 <memset>
    ...
    1208:	75 de                	jne    11e8 <fourfiles+0x178>
      exit();
    120a:	e8 84 27 00 00       	call   3993 <exit>
    ...
    1218:	e8 e3 28 00 00       	call   3b00 <printf>
        exit();
    121d:	e8 71 27 00 00       	call   3993 <exit>
    ...
    1232:	e8 c9 28 00 00       	call   3b00 <printf>
      exit();
    1237:	e8 57 27 00 00       	call   3993 <exit>
    ...
    1245:	e8 b6 28 00 00       	call   3b00 <printf>
      exit();
    124a:	e8 44 27 00 00       	call   3993 <exit>
    ...
    1258:	e8 a3 28 00 00       	call   3b00 <printf>
          exit();
    125d:	e8 31 27 00 00       	call   3993 <exit>
    ...
    127a:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    128e:	e8 f8 26 00 00       	call   398b <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    12a9:	e8 ed 26 00 00       	call   399b <wait>
    12ae:	8d 7d c8             	lea    -0x38(%ebp),%edi
  name[0] = name[1] = name[2] = 0;
    12b1:	be ff ff ff ff       	mov    $0xffffffff,%esi
    wait();
    12b6:	e8 e0 26 00 00       	call   399b <wait>
    12bb:	e8 db 26 00 00       	call   399b <wait>
    12c0:	e8 d6 26 00 00       	call   399b <wait>
  name[0] = name[1] = name[2] = 0;
  ...
  printf(1, "createdelete ok\n");
    ...
    142b:	e8 d0 26 00 00       	call   3b00 <printf>
            exit();
    1430:	e8 5e 25 00 00       	call   3993 <exit>
    1435:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
    1438:	e8 56 25 00 00       	call   3993 <exit>
    ...
    144b:	e8 b0 26 00 00       	call   3b00 <printf>
        exit();
    1450:	e8 3e 25 00 00       	call   3993 <exit>
          printf(1, "create failed\n");
    ...
    145f:	e8 9c 26 00 00       	call   3b00 <printf>
          exit();
    1464:	e8 2a 25 00 00       	call   3993 <exit>
      printf(1, "fork failed\n");
    ...
    1473:	e8 88 26 00 00       	call   3b00 <printf>
      exit();
    1478:	e8 16 25 00 00       	call   3993 <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1491:	e8 6a 26 00 00       	call   3b00 <printf>
        exit();
    1496:	e8 f8 24 00 00       	call   3993 <exit>
...
000014a0 <unlinkread>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    155a:	53                   	push   %ebx
    155b:	e8 4b 24 00 00       	call   39ab <read>
  ...
  printf(1, "unlinkread ok\n");
    ...
    exit();
    15c8:	e8 c6 23 00 00       	call   3993 <exit>
    ...
    exit();
    15db:	e8 b3 23 00 00       	call   3993 <exit>
    ...
    exit();
    15ee:	e8 a0 23 00 00       	call   3993 <exit>
    ...
    exit();
    1601:	e8 8d 23 00 00       	call   3993 <exit>
    ...
    exit();
    1614:	e8 7a 23 00 00       	call   3993 <exit>
    ...
    exit();
    1627:	e8 67 23 00 00       	call   3993 <exit>
...
00001630 <linktest>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    170d:	50                   	push   %eax
    170e:	e8 98 22 00 00       	call   39ab <read>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    17a7:	e8 e7 21 00 00       	call   3993 <exit>
    ...
    exit();
    17ba:	e8 d4 21 00 00       	call   3993 <exit>
    ...
    exit();
    17cd:	e8 c1 21 00 00       	call   3993 <exit>
    ...
    exit();
    17e0:	e8 ae 21 00 00       	call   3993 <exit>
    ...
    exit();
    17f3:	e8 9b 21 00 00       	call   3993 <exit>
    ...
    exit();
    1806:	e8 88 21 00 00       	call   3993 <exit>
    ...
    exit();
    1819:	e8 75 21 00 00       	call   3993 <exit>
    ...
    exit();
    182c:	e8 62 21 00 00       	call   3993 <exit>
    ...
    exit();
    183f:	e8 4f 21 00 00       	call   3993 <exit>
    ...
    1859:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    18b2:	83 c4 10             	add    $0x10,%esp
      wait();
    18b5:	e8 e1 20 00 00       	call   399b <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    18d2:	e8 b4 20 00 00       	call   398b <fork>
    if(pid && (i % 3) == 1){
    ...
    1910:	e8 eb 21 00 00       	call   3b00 <printf>
        exit();
    1915:	e8 79 20 00 00       	call   3993 <exit>
    ...
    192e:	83 c4 10             	add    $0x10,%esp
      exit();
    1931:	e8 5d 20 00 00       	call   3993 <exit>
  ...
  for(i = 0; i < 40; i++){
    ...
    1951:	83 c4 10             	add    $0x10,%esp
      wait();
    1954:	e8 42 20 00 00       	call   399b <wait>
  for(i = 0; i < 40; i++){
  ...
  memset(fa, 0, sizeof(fa));
    ...
    196a:	6a 00                	push   $0x0
    196c:	50                   	push   %eax
    196d:	e8 7e 1e 00 00       	call   37f0 <memset>
  fd = open(".", 0);
    1972:	5e                   	pop    %esi
    1973:	5f                   	pop    %edi
    1974:	6a 00                	push   $0x0
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1995:	57                   	push   %edi
    1996:	56                   	push   %esi
    1997:	e8 0f 20 00 00       	call   39ab <read>
  ...
  for(i = 0; i < 40; i++){
    ...
    1a2f:	0f 84 fc fe ff ff    	je     1931 <concreate+0xe1>
      wait();
    1a35:	e8 61 1f 00 00       	call   399b <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    1a4c:	e8 3a 1f 00 00       	call   398b <fork>
  ...
  printf(1, "concreate ok\n");
    ...
    1af1:	e8 0a 20 00 00       	call   3b00 <printf>
      exit();
    1af6:	e8 98 1e 00 00       	call   3993 <exit>
    ...
    exit();
    1b09:	e8 85 1e 00 00       	call   3993 <exit>
    ...
    1b1c:	e8 df 1f 00 00       	call   3b00 <printf>
        exit();
    1b21:	e8 6d 1e 00 00       	call   3993 <exit>
    ...
    1b34:	e8 c7 1f 00 00       	call   3b00 <printf>
        exit();
    1b39:	e8 55 1e 00 00       	call   3993 <exit>
      close(fd);
...
00001b50 <linkunlink>:
{
  ...
  pid = fork();
    1b75:	e8 11 1e 00 00       	call   398b <fork>
  if(pid < 0){
  ...
  if(pid)
    ...
    wait();
    1c02:	e8 94 1d 00 00       	call   399b <wait>
  printf(1, "linkunlink ok\n");
    ...
    exit();
    1c48:	e8 46 1d 00 00       	call   3993 <exit>
    exit();
    1c4d:	e8 41 1d 00 00       	call   3993 <exit>
...
00001c60 <bigdir>:
{
  ...
  printf(1, "bigdir ok\n");
    ...
    1d6d:	e8 8e 1d 00 00       	call   3b00 <printf>
      exit();
    1d72:	e8 1c 1c 00 00       	call   3993 <exit>
    ...
    1d81:	e8 7a 1d 00 00       	call   3b00 <printf>
      exit();
    1d86:	e8 08 1c 00 00       	call   3993 <exit>
    ...
    exit();
    1d99:	e8 f5 1b 00 00       	call   3993 <exit>
...
00001da0 <subdir>:
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e9f:	50                   	push   %eax
    1ea0:	e8 06 1b 00 00       	call   39ab <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f9e:	50                   	push   %eax
    1f9f:	e8 07 1a 00 00       	call   39ab <read>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    21f9:	e8 95 17 00 00       	call   3993 <exit>
    ...
    exit();
    220c:	e8 82 17 00 00       	call   3993 <exit>
    ...
    exit();
    221f:	e8 6f 17 00 00       	call   3993 <exit>
    ...
    exit();
    2232:	e8 5c 17 00 00       	call   3993 <exit>
    ...
    exit();
    2245:	e8 49 17 00 00       	call   3993 <exit>
    ...
    exit();
    2258:	e8 36 17 00 00       	call   3993 <exit>
    ...
    exit();
    226b:	e8 23 17 00 00       	call   3993 <exit>
    ...
    exit();
    227e:	e8 10 17 00 00       	call   3993 <exit>
    ...
    exit();
    2291:	e8 fd 16 00 00       	call   3993 <exit>
    ...
    exit();
    22a4:	e8 ea 16 00 00       	call   3993 <exit>
    ...
    exit();
    22b7:	e8 d7 16 00 00       	call   3993 <exit>
    ...
    exit();
    22ca:	e8 c4 16 00 00       	call   3993 <exit>
    ...
    exit();
    22dd:	e8 b1 16 00 00       	call   3993 <exit>
    ...
    exit();
    22f0:	e8 9e 16 00 00       	call   3993 <exit>
    ...
    exit();
    2303:	e8 8b 16 00 00       	call   3993 <exit>
    ...
    exit();
    2316:	e8 78 16 00 00       	call   3993 <exit>
    ...
    exit();
    2329:	e8 65 16 00 00       	call   3993 <exit>
    ...
    exit();
    233c:	e8 52 16 00 00       	call   3993 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    2341:	50                   	push   %eax
    2342:	50                   	push   %eax
    ...
    exit();
    234f:	e8 3f 16 00 00       	call   3993 <exit>
    ...
    exit();
    2362:	e8 2c 16 00 00       	call   3993 <exit>
    ...
    exit();
    2375:	e8 19 16 00 00       	call   3993 <exit>
    ...
    exit();
    2388:	e8 06 16 00 00       	call   3993 <exit>
    ...
    exit();
    239b:	e8 f3 15 00 00       	call   3993 <exit>
    ...
    exit();
    23ae:	e8 e0 15 00 00       	call   3993 <exit>
    ...
    exit();
    23c1:	e8 cd 15 00 00       	call   3993 <exit>
    ...
    exit();
    23d4:	e8 ba 15 00 00       	call   3993 <exit>
    ...
    exit();
    23e7:	e8 a7 15 00 00       	call   3993 <exit>
    ...
    exit();
    23fa:	e8 94 15 00 00       	call   3993 <exit>
    ...
    exit();
    240d:	e8 81 15 00 00       	call   3993 <exit>
    ...
    exit();
    2420:	e8 6e 15 00 00       	call   3993 <exit>
    ...
    exit();
    2433:	e8 5b 15 00 00       	call   3993 <exit>
    ...
    exit();
    2446:	e8 48 15 00 00       	call   3993 <exit>
    ...
    exit();
    2459:	e8 35 15 00 00       	call   3993 <exit>
    ...
    exit();
    246c:	e8 22 15 00 00       	call   3993 <exit>
    ...
    exit();
    247f:	e8 0f 15 00 00       	call   3993 <exit>
...
00002490 <bigwrite>:
{
  ...
  printf(1, "bigwrite ok\n");
    ...
    254f:	e8 ac 15 00 00       	call   3b00 <printf>
        exit();
    2554:	e8 3a 14 00 00       	call   3993 <exit>
    ...
    2563:	e8 98 15 00 00       	call   3b00 <printf>
      exit();
    2568:	e8 26 14 00 00       	call   3993 <exit>
...
00002570 <bigfile>:
{
  ...
  for(i = 0; i < 20; i++){
    ...
    25c6:	e8 25 12 00 00       	call   37f0 <memset>
  ...
  for(i = 0; ; i++){
    ...
    265b:	56                   	push   %esi
    265c:	e8 4a 13 00 00       	call   39ab <read>
    if(cc < 0){
  ...
  printf(1, "bigfile test ok\n");
    ...
    26b2:	e8 49 14 00 00       	call   3b00 <printf>
      exit();
    26b7:	e8 d7 12 00 00       	call   3993 <exit>
    ...
    26c6:	e8 35 14 00 00       	call   3b00 <printf>
      exit();
    26cb:	e8 c3 12 00 00       	call   3993 <exit>
    ...
    26da:	e8 21 14 00 00       	call   3b00 <printf>
      exit();
    26df:	e8 af 12 00 00       	call   3993 <exit>
    ...
    26ee:	e8 0d 14 00 00       	call   3b00 <printf>
      exit();
    26f3:	e8 9b 12 00 00       	call   3993 <exit>
    ...
    exit();
    2706:	e8 88 12 00 00       	call   3993 <exit>
    ...
    exit();
    2719:	e8 75 12 00 00       	call   3993 <exit>
    ...
    exit();
    272c:	e8 62 12 00 00       	call   3993 <exit>
...
00002740 <fourteen>:
{
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    2812:	e8 7c 11 00 00       	call   3993 <exit>
    ...
    exit();
    2825:	e8 69 11 00 00       	call   3993 <exit>
    ...
    exit();
    2838:	e8 56 11 00 00       	call   3993 <exit>
    ...
    exit();
    284b:	e8 43 11 00 00       	call   3993 <exit>
    ...
    exit();
    285e:	e8 30 11 00 00       	call   3993 <exit>
    ...
    exit();
    2871:	e8 1d 11 00 00       	call   3993 <exit>
...
00002880 <rmdot>:
{
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    296b:	e8 23 10 00 00       	call   3993 <exit>
    ...
    exit();
    297e:	e8 10 10 00 00       	call   3993 <exit>
    ...
    exit();
    2991:	e8 fd 0f 00 00       	call   3993 <exit>
    printf(1, "unlink dots/. worked!\n");
    2996:	51                   	push   %ecx
    2997:	51                   	push   %ecx
    ...
    exit();
    29a4:	e8 ea 0f 00 00       	call   3993 <exit>
    printf(1, "chdir / failed\n");
    29a9:	50                   	push   %eax
    29aa:	50                   	push   %eax
    ...
    exit();
    29b7:	e8 d7 0f 00 00       	call   3993 <exit>
    printf(1, "rm .. worked!\n");
    29bc:	50                   	push   %eax
    29bd:	50                   	push   %eax
    ...
    exit();
    29ca:	e8 c4 0f 00 00       	call   3993 <exit>
    printf(1, "rm . worked!\n");
    29cf:	50                   	push   %eax
    29d0:	50                   	push   %eax
    ...
    exit();
    29dd:	e8 b1 0f 00 00       	call   3993 <exit>
    ...
    exit();
    29f0:	e8 9e 0f 00 00       	call   3993 <exit>
...
00002a00 <dirfile>:
{
  ...
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2b5e:	e8 30 0e 00 00       	call   3993 <exit>
    ...
    exit();
    2b71:	e8 1d 0e 00 00       	call   3993 <exit>
    ...
    exit();
    2b84:	e8 0a 0e 00 00       	call   3993 <exit>
    ...
    exit();
    2b97:	e8 f7 0d 00 00       	call   3993 <exit>
    ...
    exit();
    2baa:	e8 e4 0d 00 00       	call   3993 <exit>
    ...
    exit();
    2bbd:	e8 d1 0d 00 00       	call   3993 <exit>
    ...
    exit();
    2bd0:	e8 be 0d 00 00       	call   3993 <exit>
    ...
    exit();
    2be3:	e8 ab 0d 00 00       	call   3993 <exit>
    ...
    exit();
    2bf6:	e8 98 0d 00 00       	call   3993 <exit>
    ...
    2c08:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name OK\n");
    ...
    2cfd:	e8 fe 0d 00 00       	call   3b00 <printf>
      exit();
    2d02:	e8 8c 0c 00 00       	call   3993 <exit>
    ...
    2d11:	e8 ea 0d 00 00       	call   3b00 <printf>
      exit();
    2d16:	e8 78 0c 00 00       	call   3993 <exit>
    ...
    2d28:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2d4d:	e8 39 0c 00 00       	call   398b <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2d60:	e8 36 0c 00 00       	call   399b <wait>
  ...
  if(wait() != -1){
    2d6e:	e8 28 0c 00 00       	call   399b <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2d8b:	c3                   	ret    
      exit();
    2d8c:	e8 02 0c 00 00       	call   3993 <exit>
    ...
    2d9b:	e8 60 0d 00 00       	call   3b00 <printf>
      exit();
    2da0:	e8 ee 0b 00 00       	call   3993 <exit>
    ...
    exit();
    2db3:	e8 db 0b 00 00       	call   3993 <exit>
    ...
    exit();
    2dc6:	e8 c8 0b 00 00       	call   3993 <exit>
    ...
    2dd8:	31 ff                	xor    %edi,%edi
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2e21:	0f 85 8c 02 00 00    	jne    30b3 <sbrktest+0x2e3>
  for(i = 0; i < 5000; i++){
  ...
  pid = fork();
    2e38:	e8 4e 0b 00 00       	call   398b <fork>
    2e3d:	89 c7                	mov    %eax,%edi
  if(pid < 0){
    2e3f:	85 c0                	test   %eax,%eax
    2e41:	0f 88 9b 03 00 00    	js     31e2 <sbrktest+0x412>
  c = sbrk(1);
  ...
  if(c != a + 1){
    ...
    2e65:	0f 85 60 03 00 00    	jne    31cb <sbrktest+0x3fb>
  if(pid == 0)
    2e6b:	85 ff                	test   %edi,%edi
    2e6d:	0f 84 53 03 00 00    	je     31c6 <sbrktest+0x3f6>
  wait();
    2e73:	e8 23 0b 00 00       	call   399b <wait>
  a = sbrk(0);
  ...
  if (p != a) {
    ...
    2e98:	0f 85 11 03 00 00    	jne    31af <sbrktest+0x3df>
  a = sbrk(0);
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ec3:	0f 84 cf 02 00 00    	je     3198 <sbrktest+0x3c8>
  c = sbrk(0);
  ...
  if(c != a - 4096){
    ...
    2ede:	0f 85 9d 02 00 00    	jne    3181 <sbrktest+0x3b1>
  a = sbrk(0);
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2f03:	0f 85 61 02 00 00    	jne    316a <sbrktest+0x39a>
    ...
    2f1e:	0f 85 46 02 00 00    	jne    316a <sbrktest+0x39a>
  if(*lastaddr == 99){
    2f24:	80 3d ff ff 3f 06 63 	cmpb   $0x63,0x63fffff
    2f2b:	0f 84 22 02 00 00    	je     3153 <sbrktest+0x383>
  a = sbrk(0);
  ...
  if(c != a){
    ...
    2f5a:	0f 85 dc 01 00 00    	jne    313c <sbrktest+0x36c>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    pid = fork();
    2f6f:	e8 17 0a 00 00       	call   398b <fork>
    if(pid < 0){
    2f74:	85 c0                	test   %eax,%eax
    2f76:	0f 88 a8 01 00 00    	js     3124 <sbrktest+0x354>
    if(pid == 0){
    2f7c:	0f 84 7e 01 00 00    	je     3100 <sbrktest+0x330>
    wait();
    2f82:	e8 14 0a 00 00       	call   399b <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f9b:	50                   	push   %eax
    2f9c:	e8 02 0a 00 00       	call   39a3 <pipe>
    2fa1:	83 c4 10             	add    $0x10,%esp
    2fa4:	85 c0                	test   %eax,%eax
    2fa6:	0f 85 3c 01 00 00    	jne    30e8 <sbrktest+0x318>
    2fac:	8d 75 c0             	lea    -0x40(%ebp),%esi
    2faf:	89 f7                	mov    %esi,%edi
    if((pids[i] = fork()) == 0){
    2fb1:	e8 d5 09 00 00       	call   398b <fork>
    2fb6:	89 07                	mov    %eax,(%edi)
    2fb8:	85 c0                	test   %eax,%eax
    2fba:	0f 84 91 00 00 00    	je     3051 <sbrktest+0x281>
    if(pids[i] != -1)
    ...
    2fd1:	e8 d5 09 00 00       	call   39ab <read>
  ...
  c = sbrk(4096);
    ...
    2ffa:	74 13                	je     300f <sbrktest+0x23f>
    kill(pids[i], SIGKILL);
    2ffc:	83 ec 08             	sub    $0x8,%esp
    2fff:	6a 09                	push   $0x9
    3001:	50                   	push   %eax
    3002:	e8 bc 09 00 00       	call   39c3 <kill>
    wait();
    3007:	e8 8f 09 00 00       	call   399b <wait>
    300c:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    300f:	83 c6 04             	add    $0x4,%esi
    3012:	8d 45 e8             	lea    -0x18(%ebp),%eax
    3015:	39 f0                	cmp    %esi,%eax
    3017:	75 dc                	jne    2ff5 <sbrktest+0x225>
  if(c == (char*)0xffffffff){
    3019:	83 ff ff             	cmp    $0xffffffff,%edi
    301c:	0f 84 af 00 00 00    	je     30d1 <sbrktest+0x301>
  if(sbrk(0) > oldbrk)
    3022:	83 ec 0c             	sub    $0xc,%esp
    3025:	6a 00                	push   $0x0
    3027:	e8 ef 09 00 00       	call   3a1b <sbrk>
    302c:	83 c4 10             	add    $0x10,%esp
    302f:	39 c3                	cmp    %eax,%ebx
    3031:	72 67                	jb     309a <sbrktest+0x2ca>
  printf(stdout, "sbrk test OK\n");
    3033:	83 ec 08             	sub    $0x8,%esp
    3036:	68 00 4d 00 00       	push   $0x4d00
    303b:	ff 35 00 5f 00 00    	pushl  0x5f00
    3041:	e8 ba 0a 00 00       	call   3b00 <printf>
}
    3046:	83 c4 10             	add    $0x10,%esp
    3049:	8d 65 f4             	lea    -0xc(%ebp),%esp
    304c:	5b                   	pop    %ebx
    304d:	5e                   	pop    %esi
    304e:	5f                   	pop    %edi
    304f:	5d                   	pop    %ebp
    ...
    3054:	6a 00                	push   $0x0
    3056:	e8 c0 09 00 00       	call   3a1b <sbrk>
    305b:	89 c2                	mov    %eax,%edx
    305d:	b8 00 00 40 06       	mov    $0x6400000,%eax
    3062:	29 d0                	sub    %edx,%eax
    3064:	89 04 24             	mov    %eax,(%esp)
    3067:	e8 af 09 00 00       	call   3a1b <sbrk>
      write(fds[1], "x", 1);
    306c:	83 c4 0c             	add    $0xc,%esp
    306f:	6a 01                	push   $0x1
    3071:	68 c1 47 00 00       	push   $0x47c1
    3076:	ff 75 bc             	pushl  -0x44(%ebp)
    3079:	e8 35 09 00 00       	call   39b3 <write>
    307e:	83 c4 10             	add    $0x10,%esp
    3081:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      for(;;) sleep(1000);
    3088:	83 ec 0c             	sub    $0xc,%esp
    308b:	68 e8 03 00 00       	push   $0x3e8
    3090:	e8 8e 09 00 00       	call   3a23 <sleep>
    3095:	83 c4 10             	add    $0x10,%esp
    3098:	eb ee                	jmp    3088 <sbrktest+0x2b8>
    sbrk(-(sbrk(0) - oldbrk));
    309a:	83 ec 0c             	sub    $0xc,%esp
    309d:	6a 00                	push   $0x0
    309f:	e8 77 09 00 00       	call   3a1b <sbrk>
    30a4:	29 c3                	sub    %eax,%ebx
    30a6:	89 1c 24             	mov    %ebx,(%esp)
    30a9:	e8 6d 09 00 00       	call   3a1b <sbrk>
    30ae:	83 c4 10             	add    $0x10,%esp
    30b1:	eb 80                	jmp    3033 <sbrktest+0x263>
      printf(stdout, "sbrk test failed %d %x %x\n", i, a, b);
    30b3:	83 ec 0c             	sub    $0xc,%esp
    30b6:	50                   	push   %eax
    30b7:	56                   	push   %esi
    30b8:	57                   	push   %edi
    30b9:	68 63 4c 00 00       	push   $0x4c63
    30be:	ff 35 00 5f 00 00    	pushl  0x5f00
    30c4:	e8 37 0a 00 00       	call   3b00 <printf>
      exit();
    30c9:	83 c4 20             	add    $0x20,%esp
    30cc:	e8 c2 08 00 00       	call   3993 <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    30d1:	50                   	push   %eax
    30d2:	50                   	push   %eax
    30d3:	68 e5 4c 00 00       	push   $0x4ce5
    30d8:	ff 35 00 5f 00 00    	pushl  0x5f00
    30de:	e8 1d 0a 00 00       	call   3b00 <printf>
    exit();
    30e3:	e8 ab 08 00 00       	call   3993 <exit>
    printf(1, "pipe() failed\n");
    30e8:	52                   	push   %edx
    30e9:	52                   	push   %edx
    30ea:	68 a1 41 00 00       	push   $0x41a1
    30ef:	6a 01                	push   $0x1
    30f1:	e8 0a 0a 00 00       	call   3b00 <printf>
    exit();
    30f6:	e8 98 08 00 00       	call   3993 <exit>
    30fb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    30ff:	90                   	nop
      printf(stdout, "oops could read %x = %x\n", a, *a);
    3100:	0f be 06             	movsbl (%esi),%eax
    3103:	50                   	push   %eax
    3104:	56                   	push   %esi
    3105:	68 cc 4c 00 00       	push   $0x4ccc
    310a:	ff 35 00 5f 00 00    	pushl  0x5f00
    3110:	e8 eb 09 00 00       	call   3b00 <printf>
      kill(ppid, SIGKILL);
    3115:	59                   	pop    %ecx
    3116:	5b                   	pop    %ebx
    3117:	6a 09                	push   $0x9
    3119:	57                   	push   %edi
    311a:	e8 a4 08 00 00       	call   39c3 <kill>
      exit();
    311f:	e8 6f 08 00 00       	call   3993 <exit>
      printf(stdout, "fork failed\n");
    3124:	83 ec 08             	sub    $0x8,%esp
    3127:	68 a9 4d 00 00       	push   $0x4da9
    312c:	ff 35 00 5f 00 00    	pushl  0x5f00
    3132:	e8 c9 09 00 00       	call   3b00 <printf>
      exit();
    3137:	e8 57 08 00 00       	call   3993 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    313c:	50                   	push   %eax
    313d:	56                   	push   %esi
    313e:	68 ac 54 00 00       	push   $0x54ac
    3143:	ff 35 00 5f 00 00    	pushl  0x5f00
    3149:	e8 b2 09 00 00       	call   3b00 <printf>
    exit();
    314e:	e8 40 08 00 00       	call   3993 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    3153:	56                   	push   %esi
    3154:	56                   	push   %esi
    3155:	68 7c 54 00 00       	push   $0x547c
    315a:	ff 35 00 5f 00 00    	pushl  0x5f00
    3160:	e8 9b 09 00 00       	call   3b00 <printf>
    exit();
    3165:	e8 29 08 00 00       	call   3993 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    316a:	57                   	push   %edi
    316b:	56                   	push   %esi
    316c:	68 54 54 00 00       	push   $0x5454
    3171:	ff 35 00 5f 00 00    	pushl  0x5f00
    3177:	e8 84 09 00 00       	call   3b00 <printf>
    exit();
    317c:	e8 12 08 00 00       	call   3993 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3181:	50                   	push   %eax
    3182:	56                   	push   %esi
    3183:	68 1c 54 00 00       	push   $0x541c
    3188:	ff 35 00 5f 00 00    	pushl  0x5f00
    318e:	e8 6d 09 00 00       	call   3b00 <printf>
    exit();
    3193:	e8 fb 07 00 00       	call   3993 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    3198:	57                   	push   %edi
    3199:	57                   	push   %edi
    319a:	68 b1 4c 00 00       	push   $0x4cb1
    319f:	ff 35 00 5f 00 00    	pushl  0x5f00
    31a5:	e8 56 09 00 00       	call   3b00 <printf>
    exit();
    31aa:	e8 e4 07 00 00       	call   3993 <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    31af:	50                   	push   %eax
    31b0:	50                   	push   %eax
    31b1:	68 dc 53 00 00       	push   $0x53dc
    31b6:	ff 35 00 5f 00 00    	pushl  0x5f00
    31bc:	e8 3f 09 00 00       	call   3b00 <printf>
    exit();
    31c1:	e8 cd 07 00 00       	call   3993 <exit>
    exit();
    31c6:	e8 c8 07 00 00       	call   3993 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    31cb:	50                   	push   %eax
    31cc:	50                   	push   %eax
    31cd:	68 95 4c 00 00       	push   $0x4c95
    31d2:	ff 35 00 5f 00 00    	pushl  0x5f00
    31d8:	e8 23 09 00 00       	call   3b00 <printf>
    exit();
    31dd:	e8 b1 07 00 00       	call   3993 <exit>
    printf(stdout, "sbrk test fork failed\n");
    31e2:	50                   	push   %eax
    31e3:	50                   	push   %eax
    31e4:	68 7e 4c 00 00       	push   $0x4c7e
    31e9:	ff 35 00 5f 00 00    	pushl  0x5f00
    31ef:	e8 0c 09 00 00       	call   3b00 <printf>
    exit();
    31f4:	e8 9a 07 00 00       	call   3993 <exit>
    ...
    3218:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    321e:	68 0e 4d 00 00       	push   $0x4d0e
    3223:	ff 35 00 5f 00 00    	pushl  0x5f00
    ...
    3241:	74 65                	je     32a8 <validatetest+0x98>
    sleep(0);
    ...
    325b:	6a 09                	push   $0x9
    325d:	53                   	push   %ebx
    325e:	e8 60 07 00 00       	call   39c3 <kill>
    wait();
    3263:	e8 33 07 00 00       	call   399b <wait>
    if(link("nosuchfile", (char*)p) != -1){
    3268:	59                   	pop    %ecx
    3269:	5b                   	pop    %ebx
    326a:	56                   	push   %esi
    326b:	68 1d 4d 00 00       	push   $0x4d1d
    3270:	e8 7e 07 00 00       	call   39f3 <link>
    3275:	83 c4 10             	add    $0x10,%esp
    3278:	83 f8 ff             	cmp    $0xffffffff,%eax
    327b:	75 30                	jne    32ad <validatetest+0x9d>
  for(p = 0; p <= (uint)hi; p += 4096){
    327d:	81 c6 00 10 00 00    	add    $0x1000,%esi
    3283:	81 fe 00 40 11 00    	cmp    $0x114000,%esi
    3289:	75 ad                	jne    3238 <validatetest+0x28>
  printf(stdout, "validate ok\n");
    328b:	83 ec 08             	sub    $0x8,%esp
    328e:	68 41 4d 00 00       	push   $0x4d41
    3293:	ff 35 00 5f 00 00    	pushl  0x5f00
    3299:	e8 62 08 00 00       	call   3b00 <printf>
}
    329e:	83 c4 10             	add    $0x10,%esp
    32a1:	8d 65 f8             	lea    -0x8(%ebp),%esp
    32a4:	5b                   	pop    %ebx
    32a5:	5e                   	pop    %esi
    32a6:	5d                   	pop    %ebp
    32a7:	c3                   	ret    
      exit();
    32a8:	e8 e6 06 00 00       	call   3993 <exit>
      printf(stdout, "link should not succeed\n");
    32ad:	83 ec 08             	sub    $0x8,%esp
    32b0:	68 28 4d 00 00       	push   $0x4d28
    32b5:	ff 35 00 5f 00 00    	pushl  0x5f00
    32bb:	e8 40 08 00 00       	call   3b00 <printf>
      exit();
    32c0:	e8 ce 06 00 00       	call   3993 <exit>
...
000032d0 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    32da:	68 4e 4d 00 00       	push   $0x4d4e
    32df:	ff 35 00 5f 00 00    	pushl  0x5f00
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    32ef:	90                   	nop
    if(uninit[i] != '\0'){
    32f0:	80 b8 c0 5f 00 00 00 	cmpb   $0x0,0x5fc0(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    3306:	68 69 4d 00 00       	push   $0x4d69
    330b:	ff 35 00 5f 00 00    	pushl  0x5f00
    ...
    331e:	68 58 4d 00 00       	push   $0x4d58
    3323:	ff 35 00 5f 00 00    	pushl  0x5f00
...
00003340 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    334a:	68 76 4d 00 00       	push   $0x4d76
  ...
  fd = open("bigarg-ok", 0);
    ...
    336e:	6a 00                	push   $0x0
    3370:	68 76 4d 00 00       	push   $0x4d76
  ...
  unlink("bigarg-ok");
    338e:	c7 04 24 76 4d 00 00 	movl   $0x4d76,(%esp)
    ...
    33a0:	c7 04 85 20 5f 00 00 	movl   $0x54d0,0x5f20(,%eax,4)
    33a7:	d0 54 00 00 
    ...
    33b3:	51                   	push   %ecx
    33b4:	51                   	push   %ecx
    33b5:	68 80 4d 00 00       	push   $0x4d80
    33ba:	ff 35 00 5f 00 00    	pushl  0x5f00
    args[MAXARG-1] = 0;
    33c0:	c7 05 9c 5f 00 00 00 	movl   $0x0,0x5f9c
    33c7:	00 00 00 
    printf(stdout, "bigarg test\n");
    ...
    3410:	50                   	push   %eax
    3411:	50                   	push   %eax
    3412:	68 b6 4d 00 00       	push   $0x4db6
    3417:	ff 35 00 5f 00 00    	pushl  0x5f00
    ...
    3427:	52                   	push   %edx
    3428:	52                   	push   %edx
    3429:	68 9d 4d 00 00       	push   $0x4d9d
    342e:	ff 35 00 5f 00 00    	pushl  0x5f00
    ...
    3449:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    344f:	68 cb 4d 00 00       	push   $0x4dcb
    3454:	6a 01                	push   $0x1
    ...
    34d3:	50                   	push   %eax
    34d4:	68 d8 4d 00 00       	push   $0x4dd8
    34d9:	6a 01                	push   $0x1
    ...
    350a:	68 e0 86 00 00       	push   $0x86e0
    350f:	57                   	push   %edi
    ...
    3522:	53                   	push   %ebx
    3523:	68 f4 4d 00 00       	push   $0x4df4
    3528:	6a 01                	push   $0x1
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    354c:	50                   	push   %eax
    354d:	68 e4 4d 00 00       	push   $0x4de4
    3552:	6a 01                	push   $0x1
  ...
  printf(1, "fsfull test finished\n");
    ...
    35fe:	68 04 4e 00 00       	push   $0x4e04
    3603:	6a 01                	push   $0x1
...
00003620 <uio>:
{
  ...
  printf(1, "uio test\n");
    362a:	68 1a 4e 00 00       	push   $0x4e1a
    362f:	6a 01                	push   $0x1
  ...
  printf(1, "uio test done\n");
    ...
    364c:	68 24 4e 00 00       	push   $0x4e24
    3651:	6a 01                	push   $0x1
    ...
    366e:	52                   	push   %edx
    366f:	52                   	push   %edx
    3670:	68 b0 55 00 00       	push   $0x55b0
    3675:	6a 01                	push   $0x1
    ...
    3681:	50                   	push   %eax
    3682:	50                   	push   %eax
    3683:	68 a9 4d 00 00       	push   $0x4da9
    3688:	6a 01                	push   $0x1
...
000036a0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    36ab:	6a 00                	push   $0x0
    36ad:	68 33 4e 00 00       	push   $0x4e33
  ...
  printf(1, "arg test passed\n");
    36e1:	58                   	pop    %eax
    36e2:	5a                   	pop    %edx
    36e3:	68 45 4e 00 00       	push   $0x4e45
    36e8:	6a 01                	push   $0x1
    ...
    36f7:	51                   	push   %ecx
    36f8:	51                   	push   %ecx
    36f9:	68 38 4e 00 00       	push   $0x4e38
    36fe:	6a 02                	push   $0x2
...
00003710 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3714:	69 05 fc 5e 00 00 0d 	imul   $0x19660d,0x5efc,%eax
    371b:	66 19 00 
    371e:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3723:	a3 fc 5e 00 00       	mov    %eax,0x5efc
}
    3728:	c3                   	ret    
...
00003a43 <sigret>:
SYSCALL(sigret)
    3a43:	b8 18 00 00 00       	mov    $0x18,%eax
    3a48:	cd 40                	int    $0x40
    3a4a:	c3                   	ret    
