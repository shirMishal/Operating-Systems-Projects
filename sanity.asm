...
int main(int argc, char** agrv){
  ...
  41:	83 ec 0c             	sub    $0xc,%esp
        set_ps_priority(10);
  44:	bb a0 86 01 00       	mov    $0x186a0,%ebx
        set_cfs_priority(3);
  49:	6a 03                	push   $0x3
  ...
  e4:	83 ec 0c             	sub    $0xc,%esp
                set_ps_priority(1);
  e7:	bb a0 86 01 00       	mov    $0x186a0,%ebx
                set_cfs_priority(1);
  ec:	6a 01                	push   $0x1
 ...
 12d:	83 ec 0c             	sub    $0xc,%esp
            set_ps_priority(5);
 130:	bb a0 86 01 00       	mov    $0x186a0,%ebx
            set_cfs_priority(2);
 135:	6a 02                	push   $0x2
...
printf(int fd, const char *fmt, ...)
{
 ...
 714:	eb 1a                	jmp    730 <printf+0x1a0>
          s = "(null)";
 716:	bb 75 09 00 00       	mov    $0x975,%ebx
        while(*s != 0){
