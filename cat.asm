...
main(int argc, char *argv[])
{
  ...
  6e:	50                   	push   %eax
  6f:	ff 33                	pushl  (%ebx)
  71:	68 9b 08 00 00       	push   $0x89b
  76:	6a 01                	push   $0x1
  78:	e8 93 04 00 00       	call   510 <printf>
      exit(0);
  ...
  9a:	e8 f4 02 00 00       	call   393 <exit>
  9f:	90                   	nop
...
000000a0 <cat>:
{
  ...
  b9:	6a 01                	push   $0x1
  bb:	e8 f3 02 00 00       	call   3b3 <write>
  ...
  d4:	56                   	push   %esi
  d5:	e8 d1 02 00 00       	call   3ab <read>
