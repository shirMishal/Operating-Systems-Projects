...
_u_helloworld:     file format elf32-i386
...
int main(int argc, char** argv){
  ...
  12:	83 ec 20             	sub    $0x20,%esp
    policy(1);
  15:	6a 01                	push   $0x1
  17:	e8 77 03 00 00       	call   393 <policy>
    int pid = fork();
  1c:	e8 ba 02 00 00       	call   2db <fork>
    if (pid != 0){
  21:	83 c4 10             	add    $0x10,%esp
  24:	85 c0                	test   %eax,%eax
  26:	74 38                	je     60 <main+0x60>
        int exit_code;
        wait(&exit_code);
  28:	83 ec 0c             	sub    $0xc,%esp
  2b:	8d 45 f4             	lea    -0xc(%ebp),%eax
  2e:	50                   	push   %eax
  2f:	e8 b7 02 00 00       	call   2eb <wait>
  ...
  60:	50                   	push   %eax
  61:	50                   	push   %eax
  62:	68 eb 07 00 00       	push   $0x7eb
  67:	6a 01                	push   $0x1
  69:	e8 f2 03 00 00       	call   460 <printf>
        exit(11);
  6e:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  75:	e8 69 02 00 00       	call   2e3 <exit>
  7a:	66 90                	xchg   %ax,%ax
  7c:	66 90                	xchg   %ax,%ax
  7e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb fe 07 00 00       	mov    $0x7fe,%ebx
        while(*s != 0){
