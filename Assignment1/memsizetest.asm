...
main(int argc, char *argv[])
{
  ...
  13:	e8 ab 03 00 00       	call   3c3 <memsize>
  18:	83 ec 0c             	sub    $0xc,%esp
  1b:	68 08 08 00 00       	push   $0x808
  20:	50                   	push   %eax
  21:	68 0a 08 00 00       	push   $0x80a
  26:	68 20 08 00 00       	push   $0x820
  2b:	6a 01                	push   $0x1
  2d:	e8 6e 04 00 00       	call   4a0 <printf>
 	// Allocate more memory by using malloc (array containing 20 KB).
	printf(1,"%s\n", "Allocating more memory");
  32:	83 c4 1c             	add    $0x1c,%esp
  35:	68 29 08 00 00       	push   $0x829
  3a:	68 25 08 00 00       	push   $0x825
  3f:	6a 01                	push   $0x1
  41:	e8 5a 04 00 00       	call   4a0 <printf>
	char *str;
    str = (char *) malloc(2000);
  46:	c7 04 24 d0 07 00 00 	movl   $0x7d0,(%esp)
  4d:	e8 ae 06 00 00       	call   700 <malloc>
  52:	89 c3                	mov    %eax,%ebx
 	// Print how much memory the process using now after the allocation.
    printf(1,"%s %d%s\n", "The process is using:", memsize(), "B");
  54:	e8 6a 03 00 00       	call   3c3 <memsize>
  59:	c7 04 24 08 08 00 00 	movl   $0x808,(%esp)
  60:	50                   	push   %eax
  61:	68 0a 08 00 00       	push   $0x80a
  66:	68 20 08 00 00       	push   $0x820
  6b:	6a 01                	push   $0x1
  6d:	e8 2e 04 00 00       	call   4a0 <printf>
 	// Free the array that was allocated in 2.
	printf(1,"%s\n", "Freeing memory");
  72:	83 c4 1c             	add    $0x1c,%esp
  75:	68 40 08 00 00       	push   $0x840
  7a:	68 25 08 00 00       	push   $0x825
  7f:	6a 01                	push   $0x1
  81:	e8 1a 04 00 00       	call   4a0 <printf>
	free(str);
  86:	89 1c 24             	mov    %ebx,(%esp)
  89:	e8 e2 05 00 00       	call   670 <free>
 	// Print how much memory the process is using.
    printf(1,"%s %d%s\n", "The process is using:", memsize(), "B");
  8e:	e8 30 03 00 00       	call   3c3 <memsize>
  93:	c7 04 24 08 08 00 00 	movl   $0x808,(%esp)
  9a:	50                   	push   %eax
  9b:	68 0a 08 00 00       	push   $0x80a
  a0:	68 20 08 00 00       	push   $0x820
  a5:	6a 01                	push   $0x1
  a7:	e8 f4 03 00 00       	call   4a0 <printf>
  	exit(0);
  ac:	83 c4 14             	add    $0x14,%esp
  af:	6a 00                	push   $0x0
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb 4f 08 00 00       	mov    $0x84f,%ebx
        while(*s != 0){
