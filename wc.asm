  ...
  ba:	31 db                	xor    %ebx,%ebx
{
 ...
 10c:	74 42                	je     150 <wc+0xa0>
      if(buf[i] == '\n')
 10e:	0f be 87 20 0c 00 00 	movsbl 0xc20(%edi),%eax
        l++;
 ...
 17e:	50                   	push   %eax
 17f:	50                   	push   %eax
 180:	68 ce 08 00 00       	push   $0x8ce
 185:	6a 01                	push   $0x1
 187:	e8 d4 03 00 00       	call   560 <printf>
    exit(0);
