...
fork1(void)
{
  ...
  exit(0);
      ...
      d6:	50                   	push   %eax
      d7:	68 83 19 00 00       	push   $0x1983
      dc:	68 41 13 00 00       	push   $0x1341
      e1:	6a 02                	push   $0x2
...
00000120 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     132:	68 98 12 00 00       	push   $0x1298
     137:	6a 02                	push   $0x2
     139:	e8 f2 0d 00 00       	call   f30 <printf>
  memset(buf, 0, nbuf);
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     17d:	68 35 13 00 00       	push   $0x1335
     182:	6a 02                	push   $0x2
     184:	e8 a7 0d 00 00       	call   f30 <printf>
  exit(0);
...
000001a0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c1:	3e ff 24 85 50 13 00 	notrack jmp *0x1350(,%eax,4)
     1c8:	00 
    if(pipe(p) < 0)
  ...
  if(pid == -1)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     277:	68 a2 12 00 00       	push   $0x12a2
     27c:	6a 02                	push   $0x2
     27e:	e8 ad 0c 00 00       	call   f30 <printf>
    break;
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     36c:	68 c2 12 00 00       	push   $0x12c2
...
00000380 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     399:	68 c2 12 00 00       	push   $0x12c2
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3bb:	6a 54                	push   $0x54
     3bd:	e8 ce 0d 00 00       	call   1190 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3eb:	6a 18                	push   $0x18
     3ed:	e8 9e 0d 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     4bb:	6a 08                	push   $0x8
     4bd:	e8 ce 0c 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     5ae:	50                   	push   %eax
     5af:	68 58 19 00 00       	push   $0x1958
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     5d0:	56                   	push   %esi
     5d1:	68 60 19 00 00       	push   $0x1960
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     67d:	50                   	push   %eax
     67e:	68 60 19 00 00       	push   $0x1960
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     6eb:	68 e9 12 00 00       	push   $0x12e9
     6f0:	53                   	push   %ebx
     6f1:	56                   	push   %esi
  ...
  return cmd;
     ...
     776:	68 cc 12 00 00       	push   $0x12cc
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     793:	68 ec 12 00 00       	push   $0x12ec
     798:	57                   	push   %edi
     799:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     7e6:	68 03 13 00 00       	push   $0x1303
     7eb:	57                   	push   %edi
     7ec:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     830:	68 f5 12 00 00       	push   $0x12f5
  ...
  cmd->eargv[argc] = 0;
     ...
     882:	68 ee 12 00 00       	push   $0x12ee
...
00000890 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8ad:	68 08 13 00 00       	push   $0x1308
  cmd = parseexec(ps, es);
...
00000900 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     943:	68 0a 13 00 00       	push   $0x130a
     948:	57                   	push   %edi
     949:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     959:	68 06 13 00 00       	push   $0x1306
     95e:	57                   	push   %edi
     95f:	56                   	push   %esi
...
000009b0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     9c3:	68 ec 12 00 00       	push   $0x12ec
     9c8:	56                   	push   %esi
     9c9:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     9ed:	68 28 13 00 00       	push   $0x1328
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     a5d:	3e ff 24 85 68 13 00 	notrack jmp *0x1368(,%eax,4)
     a64:	00 
...
00000b00 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     b2b:	68 b1 12 00 00       	push   $0x12b1
     b30:	53                   	push   %ebx
     b31:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     b53:	52                   	push   %edx
     b54:	50                   	push   %eax
     b55:	68 2a 13 00 00       	push   $0x132a
     b5a:	6a 02                	push   $0x2
     b5c:	e8 cf 03 00 00       	call   f30 <printf>
    panic("syntax");
     b61:	c7 04 24 ee 12 00 00 	movl   $0x12ee,(%esp)
     ...
     e8c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
     ...
     efe:	56                   	push   %esi
     eff:	57                   	push   %edi
     f00:	e8 ee fe ff ff       	call   df3 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
     ...
     f79:	e8 75 fe ff ff       	call   df3 <write>
  ...
  write(fd, &c, 1);
     ...
     fd9:	e8 15 fe ff ff       	call   df3 <write>
        putc(fd, c);
      } else {
  ...
  write(fd, &c, 1);
     ...
     fed:	e8 01 fe ff ff       	call   df3 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    1064:	e8 8a fd ff ff       	call   df3 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    10db:	57                   	push   %edi
    10dc:	53                   	push   %ebx
    10dd:	e8 11 fd ff ff       	call   df3 <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    11fb:	e8 5b fc ff ff       	call   e5b <sbrk>
  if(p == (char*)-1)
